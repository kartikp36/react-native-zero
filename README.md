This repository is a fork of [Aora](https://github.com/adrianhajdin/aora/) Video Sharing App built following the ["React Native Course for Beginners in 2024 | Build a Full Stack React Native App" tutorial by JavaScript Mastery](https://youtu.be/ZBCUegTZF7M?si=LYfMTEDNTQr-fnvY). 
This project taught me:

- **Fundamentals of mobile app development** with **React Native** and **Appwrite**.
- Smooth transition from **Next.js to Expo**, making it very easy for Next.js developers to dive into mobile app development using React Native.
- **Styling with Nativewind**, mirroring the ease of Tailwind CSS.
- Adding **captivating animations with Animatable** for better user engagement.
- **Implementing secure authentication** and real-time data handling.
- Building **responsive UIs** and interactive features like search, upload and more.
